...
We refactored all javascripts in [#1545](https://github.com/shopsys/shopsys/pull/1545). You have two way 
how to realize upgrade. The first way is incorporate changes with access with framework common javascripts. 
This changes are descripted in diffs on next lines. The second way is to download all new javascripts from 
[project-base/assets/js](https://github.com/shopsys/shopsys/blob/9.0/project-base/assets/js) and put into 
them your changes. You can found git diff command after individual files.

We recomend the second way although it is more demanding because new javascripts will be use as source for next upgrade notes. 
...
Or you can change full different between your old file and new file
```sh
